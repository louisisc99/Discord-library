...
function DiscordLib:Window(text)
	...
	ServersHold.Size = UDim2.new(0, 50, 0, 250)
...
return DiscordLib
    -- Example fix for slider functionality
    Slider.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType.Touch then
            ...
            local function updateSlider(input)
                ...
                Slider.Position = UDim2.new(0, math.clamp(delta, 0, MaxWidth), 0, 0)
            end
...
-- Example color picker improvements
ColorPicker.InputBegan:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType.Touch then
        local position = input.Position
        local color = Color3.fromRGB(math.clamp(position.X, 0, 255), math.clamp(position.Y, 0, 255), 100)
